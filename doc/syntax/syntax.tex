...
\author{\large James Hanlon}
\date{\large May 13, 2014\\{\small (last revised \today)}}
...
\allowdisplaybreaks
% Set spacing before flalign
\setlength{\abovedisplayskip}{0pt}
%\setlength{\jot}{2mm}

\section{Collected syntax}

The following sections list the \sire\ syntax, with each section collecting
